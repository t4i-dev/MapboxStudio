package com.example.mapboxstudio;
...
public class NavigationboxStudio extends AppCompatActivity {
    MapView mapView;
    ...
    private final ActivityResultLauncher<String> activityResultLauncher = registerForActivityResult(new ActivityResultContracts.RequestPermission(), new ActivityResultCallback<Boolean>() {
        ...
        public void onActivityResult(Boolean result) {
            if (result) {
                Toast.makeText(NavigationboxStudio.this, "Permission granted! Restart this app", Toast.LENGTH_SHORT).show();
            }
        }
    });
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.navigationboxstudio);
        ...
        speechApi = new MapboxSpeechApi(NavigationboxStudio.this, getString(R.string.mapbox_access_token), Locale.US.toLanguageTag());
        mapboxVoiceInstructionsPlayer = new MapboxVoiceInstructionsPlayer(NavigationboxStudio.this, Locale.US.toLanguageTag());
        ...
        if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.TIRAMISU) {
            if (ActivityCompat.checkSelfPermission(NavigationboxStudio.this, Manifest.permission.POST_NOTIFICATIONS) != PackageManager.PERMISSION_GRANTED) {
                activityResultLauncher.launch(Manifest.permission.POST_NOTIFICATIONS);
            }
        }

        if (ActivityCompat.checkSelfPermission(NavigationboxStudio.this, Manifest.permission.ACCESS_FINE_LOCATION) != PackageManager.PERMISSION_GRANTED
                && ActivityCompat.checkSelfPermission(NavigationboxStudio.this, Manifest.permission.ACCESS_COARSE_LOCATION) != PackageManager.PERMISSION_GRANTED) {
        ...
        setRoute.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                Toast.makeText(NavigationboxStudio.this, "Please select a location in map", Toast.LENGTH_SHORT).show();
            }
        });
        ...
        mapView.getMapboxMap().loadStyleUri(Style.SATELLITE, new Style.OnStyleLoaded() {
            ...
            public void onStyleLoaded(@NonNull Style style) {
                ...
                Bitmap bitmap = BitmapFactory.decodeResource(getResources(), R.drawable.ic_destination);
    ...
    private void fetchRoute(Point point) {
        LocationEngine locationEngine = LocationEngineProvider.getBestLocationEngine(NavigationboxStudio.this);
            ...
            public void onSuccess(LocationEngineResult result) {
                ...
                mapboxNavigation.requestRoutes(builder.build(), new NavigationRouterCallback() {
                    ...
                    public void onFailure(@NonNull List<RouterFailure> list, @NonNull RouteOptions routeOptions) {
                        setRoute.setEnabled(true);
                        setRoute.setText("Set route");
                        Toast.makeText(NavigationboxStudio.this, "Route request failed", Toast.LENGTH_SHORT).show();
                    }
